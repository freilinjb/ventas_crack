...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Adminiscación de Categoria</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <!-- <li class="breadcrumb-item"><a href="#">Layout</a></li> -->
          <li class="breadcrumb-item active">Administración de Categoria</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
    ...
    <div class="modal-content">
      <form id="formEmployee">
        <div class="modal-header bg-info">
          <h4 class="modal-title">Register Categoria</h4>
                ...
                <div class="col-6-lg col-xl-6 col-sm-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="categoria" id="categoria" value="crack2" placeholder="Ingrese una descripcion " autocomplete="off">
                    </div>
                    <!-- /.input group -->
                  </div>
                </div>
