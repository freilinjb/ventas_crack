<?php
    $estandar = EstandarController::getEstandar(null, null);
    // print_r($estandar);
?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Estandar</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Administracion de estandar
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="">
                            <button class="btn btn-info mb-3" data-toggle="modal" data-target="#registrarEstandar">
                        ...
                        <table id="empleados" class="table table-bordered table-striped table-hover float-left float-right">
                            ...
                            <tbody>
                                ...
                                foreach ($estandar as $key => $value) {
                                    ...
                                    echo '<tr>
                                    <td>' . ($key + 1) . '</td>
                                    <td>' . $value["Estandar"] . '</td>
                                    <td>' . $value["creado_en"] . '</td>
                                    <td>' . $estado . '</td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-info btnEditarEstandar" data-toggle="modal" data-target="#editarEstandar" idEstandar="' . $value["idEstandar"] . '"><i class="fas fa-eye"></i></button>
                                            <button type="button" class="btn btn-light btnDesactivarEstandar" data-target="#editarEstandar" idEstandar="' . $value["idEstandar"] . '"><i class="fas fa-edit"></i></button>
                                            <button type="button" class="btn btn-dark btnEliminarEstandar" data-target="#editarEstandar" idEstandar="' . $value["idEstandar"] . '"><i class="fas fa-trash"></i></button>
                                        </div>
...
<div class="modal fade" id="registrarEstandar" style="display: none; padding-right: 17px;" aria-modal="true">
                                ...
                                <div class="col-6-lg col-xl-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="estandar" id="estandar" placeholder="Ingrese el nombre del estandar" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6-lg col-xl-6 col-sm-12">
...
<div class="modal fade" id="editarEstandar" style="display: none; padding-right: 17px;" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
