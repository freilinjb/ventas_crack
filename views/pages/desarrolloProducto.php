        ...
        <div class="card card-info card-outline">
          <div class="card-header">
            <h3 class="card-title">
              ...
              Administracion de Desarrollo de producto
            </h3>
          </div>
          <div class="card-body">
            <div class="">
            ...
            <table id="empleados" class="table table-bordered table-striped table-hover float-left float-right">
              ...
              <tbody>
                ...
                UserController::mostrarUsuarios(null, null);
                $estado = null;
...
<div class="modal fade" id="registrarDesarrolloProductos" style="display: none; padding-right: 17px;" aria-modal="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <?php
      $DesarrolloProductos = new DesarrolloProductosController();
      $DesarrolloProductos->registrarDesarrolloProductos();
      ?>
    </div>
    <!-- /.modal-content -->
  </div>
...
<?php
$eliminarDesarrolloProductos = new DesarrolloProductosController();
$eliminarDesarrolloProductos->eliminarDesarrolloProductos();
?>
<!-- END MODAL REGISTRAR EMPLEADO-->
