...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Adminiscación de Unidades</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <!-- <li class="breadcrumb-item"><a href="#">Layout</a></li> -->
          <li class="breadcrumb-item active">Administración de Unidad</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
                ...
                <div class="col-6-lg col-xl-6 col-sm-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="unidad" id="unidad" value="crack2" placeholder="Ingrese una descripcion " autocomplete="off">
                    </div>
                    <!-- /.input group -->
                  </div>
                </div>
